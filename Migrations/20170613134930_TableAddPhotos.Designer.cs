...
namespace BdelivServices.Migrations
{
    ...
    [Migration("20170613134930_TableAddPhotos")]
    partial class TableAddPhotos
    {
        protected override void BuildTargetModel(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity("bdeliv_services.Models.Photo", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("bdeliv_services.Models.ProductTags", b =>
                {
                    b.Property<int>("ProductId");
            ...
            modelBuilder.Entity("bdeliv_services.Models.Photo", b =>
                {
                    b.HasOne("bdeliv_services.Models.Product")
                        .WithMany("Photos")
            ...
            modelBuilder.Entity("bdeliv_services.Models.ProductTags", b =>
                {
                    b.HasOne("bdeliv_services.Models.Product", "Product")
                        .WithMany("Tags")
                        .HasForeignKey("ProductId")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("bdeliv_services.Models.Tag", "Tag")
                        .WithMany()
                        .HasForeignKey("TagId")
                        .OnDelete(DeleteBehavior.Cascade);
                });
